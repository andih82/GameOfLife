    ...
    companion object {
        ...
        fun defaultSart(): Universe {
            return if (SIZE >= 50) Universe().apply {
                ...
                grid[22][22].state = CellState.ALIVE
                grid[22][23].state = CellState.ALIVE
                grid[22][24].state = CellState.ALIVE
                grid[23][22].state = CellState.ALIVE
                grid[23][24].state = CellState.ALIVE
                grid[24][22].state = CellState.ALIVE
                grid[24][24].state = CellState.ALIVE

                grid[28][22].state = CellState.ALIVE
                grid[28][23].state = CellState.ALIVE
                grid[28][24].state = CellState.ALIVE
                grid[27][22].state = CellState.ALIVE
                grid[27][24].state = CellState.ALIVE
                grid[26][22].state = CellState.ALIVE
                grid[26][24].state = CellState.ALIVE
                ...
                grid[3][4].state = CellState.ALIVE
                grid[3][5].state = CellState.ALIVE
                grid[4][3].state = CellState.ALIVE
                grid[4][4].state = CellState.ALIVE
                grid[4][5].state = CellState.ALIVE
                grid[5][3].state = CellState.ALIVE
                grid[5][4].state = CellState.ALIVE
                grid[5][5].state = CellState.ALIVE
            }
            else Universe()
        }
    }
